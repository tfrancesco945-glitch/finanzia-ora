        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center gap-7 ml-10">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-sm font-medium text-gray-600 hover:text-brand-navy transition-colors duration-200"
              >
                {link.label}
              </Link>
            ))}
          ...
          <div className="hidden lg:flex items-center gap-3 ml-8">
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-[#25D366] border border-[#25D366] rounded-lg hover:bg-[#25D366]/8 transition-colors duration-200"
            >
              <WhatsAppIconSmall />
              WhatsApp
            </a>
        ...
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col gap-1">
          {navLinks.map((link) => (
            <Link
              ...
              className="text-base font-medium text-gray-700 hover:text-brand-navy hover:bg-brand-light px-3 py-3 rounded-lg transition-colors"
            >
              {link.label}
            </Link>
          ))}
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-brand-light mt-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-[#25D366] border border-[#25D366] rounded-xl"
            >
              <WhatsAppIconSmall />
              WhatsApp
            </a>
